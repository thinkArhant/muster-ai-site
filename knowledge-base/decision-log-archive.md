...
## Sprint 1 decisions — archived 2026-07-26 at sprint closeout

DEC-001 through DEC-030. The binding content of these decisions lives on in durable artifacts —
`foundational-assumptions.md` (A-001…A-009), the project `CLAUDE.md`, `page-shell.md`,
`section-02-replay.md`, `copy-rules.md` and `pre-launch-checklist.md`. These entries are the reasoning
and the history; consult them when you need to know *why*, not *what*.
